<template>
    <div id="clientList" class="wrapper">
        ...
        <div class="rightBlock">
            <div class="rightTabbar">
                ...
                <div class="rt-handle">
                    ...
                    <div class="handle-item">
                        <button type="button" name="button" @click="deleteData(1)">批量删除</button>
                    </div>
                    <div class="handle-item">
                    ...
                    <table class="list" border="1" cellspacing="0" cellpadding="0" :style="{width: width+'px'}">
                        ...
                        <tbody class="list-con">
                            ...
                            <tr v-if="ifPage" v-for="(item,index) of items" class="list-con-item">
                                ...
                                <td>{{item.remark}}</td>
                                <td>
                                    <a href="javascript:;" @click="deleteData(2,item.clientid)" class="mode">删除</a>
        ...
        <alert-v v-on:close="close" height="320px" :btn="btn" v-on:next="next" v-if="addDialog">
            <span slot="name">{{addType===1?'添加':'编辑'}}客户</span>
    ...
    methods: {
        ...
        getData() {
            ...
            let data = {
                ...
                clientnameoraddress: this.keywords
            }
